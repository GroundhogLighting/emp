...
//! Fills a Light object with data contained in a Lua table
/*!
 @author German Molina
 @param[in] o The Light object to fill
...
void fillData(Light * o, lua_State * L, int tableIndex);

//! Adds a new light object to the GroundhogModel
/*!
 @author German Molina
 @param[in] L The lua_State of the api
 @return the number of return values within the script
