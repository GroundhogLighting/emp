...
void fillData(Trans * m, lua_State * L, int tableIndex)
{
    ...
    m->transmissivity = getNumberFromTableField(L, tableIndex, "transmissivity");
    m->tspec = getNumberFromTableField(L, tableIndex, "tspec");    
}

int createTrans(lua_State * L)
{
    return createMaterial(L,"trans");    
}
